...
An engineering project focused on **High-Performance Computing (HPC)** and **MLOps** practices applied to the fine-tuning of the **DeepSeek-V2 Lite** language model. This repository demonstrates a standardized workflow from a local development environment (Minikube) to a production-ready cloud architecture on AWS using Infrastructure as Code (IaC).

## 🚀 Project Overview

The core objective is to explore techniques that enable training of Large Language Models (LLMs) on both consumer-grade and cloud-based hardware.
